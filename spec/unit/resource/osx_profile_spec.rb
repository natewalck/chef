...
describe Chef::Resource::OsxProfile do
  before(:each) do
    @resource = Chef::Resource::OsxProfile.new("Test Profile Resource")
  end

  it "should create a new Chef::Resource::Profile" do
    expect(@resource).to be_a_kind_of(Chef::Resource)
    expect(@resource).to be_a_kind_of(Chef::Resource::Profile)
  end

  it "should have a resource name of profile" do
    expect(@resource.resource_name).to eql(:profile)
  end
